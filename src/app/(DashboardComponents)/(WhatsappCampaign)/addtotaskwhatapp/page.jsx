...
const WhatsAppAddToTask = ({ setClose, item, userID, fetchData }) => {
        ...
        <div className="bg-gradient-to-r from-green-600 to-emerald-600 text-white px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                <h2 className="text-xl font-bold">Add WhatsApp to Task</h2>
                <p className="text-green-100 text-sm mt-1">Assign this WhatsApp item to a task</p>
              </div>
            </div>
            <button
              ...
              disabled={submitting}
            >
              <IoMdClose className="text-green-500 text-lg" />
            </button>
          </div>
        </div>
                ...
                {tasks.length === 0 ? (
                  <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-xl p-8 text-center">
                    <div className="w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center mx-auto mb-4">
                      <FiList className="text-2xl text-gray-400" />
                    </div>
                  ...
                  <div className="relative">
                    ...
                    <select
                      name="task"
                      id="task"
                      className="w-full pl-12 pr-4 py-4 border-2 border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-4 focus:ring-green-100 focus:border-green-500 transition-all duration-200 text-gray-700 font-medium"
                      value={selectedTask}
...
export default WhatsAppAddToTask;