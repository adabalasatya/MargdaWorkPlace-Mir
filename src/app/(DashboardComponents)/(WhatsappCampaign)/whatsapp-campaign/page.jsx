...
import { FaArrowLeft, FaWhatsapp, FaChartLine, FaUsers, FaEye, FaEdit, FaTrash, FaPaperPlane } from "react-icons/fa";
import {
  FiEye,
  FiTrash2,
  FiSearch,
...
const WhatsAppCampaign = () => {
  ...
  const fetchData = async (userID) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://www.margda.in/miraj/work/whatsapp-campaign/get-campaigns",
        {
          method: "POST",
          headers: {
  ...
  const handleSend = async (id) => {
    const result = await Swal.fire({
      ...
      text: "Are you sure you want to send this WhatsApp campaign?",
      icon: "question",
    ...
    try {
      const response = await fetch(
        "https://www.margda.in/miraj/work/whatsapp-campaign/start-campaign",
        {
          method: "POST",
          headers: {
            "content-type": "application/json",
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await fetch(
        "https://www.margda.in/miraj/work/whatsapp-campaign/create-campaign",
        {
          method: "POST",
          headers: {
            "content-type": "application/json",
  ...
  <div className="flex items-center justify-center gap-3">
    ...
    <h1 className="text-2xl font-bold text-gray-800">WhatsApp Campaigns</h1>
  </div>
  ...
  <button
    onClick={toggleModal}
    disabled={loading}
    className="inline-flex items-center px-4 py-2 text-md bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold rounded-xl hover:from-green-700 hover:to-emerald-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 disabled:opacity-50"
  >
  ...
  <div className="bg-white rounded-xl p-4 shadow-md border border-gray-100">
    <div className="flex items-center">
      <div className="w-9 h-9 bg-amber-100 rounded-lg flex items-center justify-center">
        <FaWhatsapp className="text-amber-600 text-lg" />
      </div>
      <div className="ml-3">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              ...
              <div className="flex flex-wrap items-center gap-4">
                <div className="flex items-center gap-2">
                  ...
                  <select
                    ...
                    className="px-3 py-2 border-2 border-gray-200 rounded-lg focus:ring-4 focus:ring-green-100 focus:border-green-500 focus:outline-none transition-all"
                  >
                    {[10, 20, 50].map((val) => (
              ...
              <div className="flex">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-green-100 focus:border-green-500 focus:outline-none transition-all w-64"
                />
              </div>
            </div>
          </div>
          ...
          {filteredCampaigns.length > 0 && (
            <div className="bg-gray-50 px-6 py-4 border-t border-gray-200 flex flex-col sm:flex-row justify-between items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="px-4 py-2 bg-green-600 text-white rounded-xl font-medium text-sm">
                  {currentPage}
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-2xl font-bold">
                    {isEditing ? "Edit WhatsApp Campaign" : "Create New WhatsApp Campaign"}
                  </h2>
                  <p className="text-green-100 mt-1">
                    {isEditing ? "Update campaign details" : "Set up your WhatsApp marketing campaign"}
                  </p>
                </div>
                <button
                  onClick={toggleModal}
                ...
                >
                  <IoMdClose className="text-green-500 text-xl" />
                </button>
              </div>
            </div>
              ...
              <div className="space-y-8">
                ...
                <div>
                  <div className="flex items-center mb-4">
                    <div className="w-6 h-6 bg-green-600 rounded-full flex items-center justify-center text-white font-bold mr-3">1</div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-green-100 focus:border-green-500 focus:outline-none transition-all duration-200"
                ...
                <div>
                  <div className="flex items-center mb-6">
                    <div className="w-6 h-6 bg-green-600 rounded-full flex items-center justify-center text-white font-bold mr-3">2</div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        <select
                          ...
                          className="flex-1 px-4 py-2 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-green-100 focus:border-green-500 focus:outline-none transition-all duration-200"
                          required
                        >
